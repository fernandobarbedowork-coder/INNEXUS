      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
        <div className="max-w-5xl space-y-8">
          ...
          <div className="pt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href="#contacto" className="group inline-flex items-center space-x-3 bg-yellow-600 hover:bg-yellow-500 text-white px-10 py-5 rounded-full transition-all w-full sm:w-auto justify-center">
              <span className="font-bold tracking-widest text-xs uppercase">AGENDÁ UNA LLAMADA</span>
              <ChevronRight className="group-hover:translate-x-1 transition-transform" />
            </a>
            <Link to="/club-inversores" className="group inline-flex items-center space-x-3 bg-white/10 hover:bg-white/20 backdrop-blur-md text-white px-10 py-5 rounded-full transition-all border border-white/10 w-full sm:w-auto justify-center">
              <Users size={18} className="text-yellow-500" />
              <span className="font-bold tracking-widest text-xs uppercase">Club de Inversores Innexus</span>
            </Link>
          </div>
        </div>
      </div>
